...
|----------|------|------|---------------|--------|-------|
| 1 | YYYY-MM-DD | `transcript_file.txt` | Class #NN: Title | `pending` | |
| 2 | YYYY-MM-DD | `transcript_file.txt` | Class #NN: Title | `pending` | |
...
|--------|------|-------|-----------------|-------------|---------------|-----------|-----------|
| 1 | YYYY-MM-DD | Title | `raw/file.txt` | `YYYY-MM-DD_class01_review.md` | 3 | 1 | YYYY-MM-DD |
| 2 | YYYY-MM-DD | Title | `raw/file.txt` | `YYYY-MM-DD_class02_review.md` | 5 | 2 | YYYY-MM-DD |
...
|------|----------------|----------------|---------------|
| `filename.txt` | YYYY-MM-DD | Class #NN? | Manual confirm |

...
- Real-world application exercise (Crans Montana)
- The "migration" concept (mens rea → causation)

**Verdict:** Prep was 60% accurate. Should have anticipated broader homicide sweep.
...
1. **Factual Cause (But-For Test)**
   ...
   - **Problem:** Infinite but-for causes exist
...
2. **Proximate Cause (Legal Causation)**
   ...
   - Standards used:
     ...
     - "Not too remote or accidental" (MPC § 2.03)
     - "Foreseeable"
     - "Substantial factor"
   - **Reality:** These are all **post-hoc rationalizations** for liability decision
   - Quote: "Proximate cause... is artificial, serving matters of policy surrounding tort and criminal law"
...
**Willansky:** Innkeeper/proprietor duty (probably historical common law)

---

## Specific Cases - Exam-Ready Analysis
...
- Willansky in hospital during fire
...
- **Intervening cause defense:** Barback's match-lighting
  - But-for: YES
  - Proximate: Foreseeable in environment with flammable decorations, locked exits, overcrowding
- **Standard twist:** Calls itself subjective (wanton/reckless) but applies objective test
...
- Firefighter died from smoke inhalation (from 2nd fire, not defendant's)
...
1. **Factual Cause (But-For)**
   - Sine qua non test: Would harm have occurred without defendant's conduct?
   - Very broad - captures many links in causal chain
   - Insufficient alone

2. **Proximate Cause (Legal Causation)**
   - Policy-driven determination of liability scope
   - Tests/standards (all artificial):
     - "Not highly extraordinary result" (*Acosta*)
     - "Not too remote or accidental" (MPC § 2.03)
     - Foreseeability
     - Substantial factor
   - **Reality:** Post-hoc rationalization of liability decision
...
### Key Cases
- **Willansky:** Omission liability for nightclub owner; intervening cause (barback's match) doesn't break chain when defendant created dangerous conditions
- **Acosta:** Proximate cause satisfied for helicopter collision (foreseeable in pursuit), but implied malice not shown
- **Arzon:** "Zone of vulnerability" doctrine - defendant liable even when separate fire actually caused death
- **Williams:** Washington allows civil negligence for manslaughter; causation defense if harm inevitable by certain date
```

### [INSERT INTO MENS REA SECTION - NEGLIGENCE]

```markdown
## Criminal Negligence Variations

### State-by-State Differences
- **Massachusetts (*Willansky*):** NO criminal negligence statute; requires "wanton and reckless" but applies OBJECTIVE standard
- **Washington (*Williams*):** Simple CIVIL negligence sufficient for statutory manslaughter
- **MPC:** Criminal negligence = gross deviation from standard of care (objective test with high threshold)

### Key Quote - Willansky Standard
"Even if a particular defendant is so stupid or so heedless that in fact he did not realize the grave danger, he could escape the imputation of wanton and reckless conduct in his dangerous behavior, if an ordinary normal man under the same circumstances would have realized the gravity of the danger."
- Sounds subjective (wanton/reckless)
- Actually objective (reasonable person standard)
- **High degree of risk required**
```
...
### New Concepts to Index

- **"Zone of vulnerability" doctrine** (*Arzon*)
- **"Indispensable link" test** (*Arzon*)
- **Crystalline structure applies to intervening causes**
- **Omission liability sources** (*Jones* case - 4 duties)
- **"Smooshing" standards** (Williams - collapsing civil/criminal negligence)

---

## Prewrite Opportunities

### 1. Proximate Cause Essay
...
- Foreseeability has meaningful content (compare *Acosta* dissent)
...
### 3. State Regulatory Failure + Criminal Liability
...
**Transcription quality:** Excellent - clear audio, minimal errors

**Notable corrections needed:** None significant

**Context captured:** Yes - including video shown in class

---

## Class Mechanics Notes
...
- Sparkler tradition (waitress on shoulders near ceiling)
...
- **9 years safe operation** (if similar to Willansky argument)
...
4. How real cases trigger same analysis as hypotheticals

---

## Meta-Learning: Harcourt's Teaching Method
...
Harcourt: The paragraph on proximate cause (p. 605, 11th ed.) is "**the most important paragraph you're gonna read in your first year of law school**"

**Why:** "All legal terms are artificial... it's up to you to push the court to define those terms in a way that benefits your client"

**Exam application:** Don't treat legal terms as fixed. They're containers you fill with arguments.
...
**Exam application:** Always have backup arguments at different doctrinal levels
...
4. **Proximate causation:**
   ...
   - Degree of risk
   - Substantial factor
5. **Intervening causes?** If yes:
   - Apply full two-part test to intervening cause
   - Zone of vulnerability argument
   - Superseding cause arguments
...
1. **MPC § 2.03 differences** for purpose/knowledge vs. recklessness/negligence
2. **More hypo practice** on intervening causes
3. **State-by-state variations** on negligence standards
4. **Past exam causation questions** to see patterns

### Confidence Level

- **Causation framework:** ✓ Solid (but-for + proximate)
- **Intervening causes:** ✓ Good (crystalline structure makes sense)
- **Case applications:** ✓ Strong (Acosta, Arzon, Willansky clear)
- **Integration with mens rea:** ~ Need more practice (migration concept)

### Study Priorities Before Next Class

1. Review MPC § 2.03 in detail (all subsections)
2. Outline integration: Causation + mens rea flowchart
3. Write practice intervening cause hypos
4. Review *Jones* case (omission duties) - referenced but not in prep
...
- Review Jones case (omission liability)

...
|--------|------|-------|-----------------|-------------|---------------|-----------|-----------|
| 1 | 2026-01-21 | “Walk-In Blind” — Tort Theory + Negligence Preview (Adams v. Bullock) | `03_TRANSCRIPTS/raw/Torts-transcript-01-21.txt` | `04_REVIEWS/2026-01-21_class01_review.md` | 0 | 0 | 2026-01-22 |
...
4. Alternative filename patterns supported:
   - `{CourseName}-transcript-MM-DD.txt` (preferred; e.g., `Torts-transcript-01-21.txt`)
